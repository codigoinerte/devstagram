    ...
    <div class="md:flex md:justify-center md:gap-4 md:items-center">
        ...
        <div class="md:w-4/12 bg-white p-6 rounded-lg shadow-xl">
            <form method="POST" action="{{ route('login') }}" novalidate>
                ...
                <div class="mb-5">
                    <input type="checkbox" name="remember" id="remember"> <label class="text-gray-500 font-bold" for="remember" >Mantener mi sesión abierta </label>
                </div>
                <div class="mb-5 text-center">
                    <a href="{{ route('recovery.index') }}" class="font-normal cursor-pointer text-sm text-gray-500">Recuperar password</a>
                </div>
